...
(() => {
	const e = {
		...
		408: (e, t) => {
			...
			const s = Symbol.for('react.suspense');
			...
			function $(e, t, n) {
				...
				if (t != null)
					for (o in (void 0 !== t.ref && (c = t.ref), void 0 !== t.key && (a = `${t.key}`), t))
						R.call(t, o) && !O.hasOwnProperty(o) && (u[o] = t[o]);
			...
			function g(e, t, o, u, a) {
				...
				if (i) {
					return (
						...
						(e = u === '' ? `.${j(i, 0)}` : u),
						E(a)
							? ((o = ''), e != null && (o = `${e.replace(C, '$&/')}/`), g(a, t, o, '', (e) => e))
							: a != null &&
							  (k(a) &&
									(a = (function (e, t) {
										return {
			...
			const D = { ReactCurrentDispatcher: I, ReactCurrentBatchConfig: T, ReactCurrentOwner: w };
			(t.Children = {
				map: x,
				forEach(e, t, r) {
					x(
				...
				(t.cloneElement = function (e, t, n) {
					...
					if (f === 1) o.children = n;
						...
						i = Array(f);
						for (let s = 0; s < f; s++) i[s] = arguments[s + 2];
						o.children = i;
					}
					return {
						$$typeof: r,
	...
	(r.d = (e, t) => {
		for (const n in t) r.o(t, n) && !r.o(e, n) && Object.defineProperty(e, n, { enumerable: !0, get: t[n] });
	}),
